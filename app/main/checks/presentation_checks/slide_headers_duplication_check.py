...
class SlideHeadersDuplicationCheck(BasePresCriterion):
    ...
    def check(self):
        ...
        if not result_str:
            ...
            result_str += (
                'Примечание: в крайнем случае, если без дублирования не обойтись (например, одна задача '
                'размещена на нескольких слайдах), добавьте цифры 1,2,3 к названиям: '
                '"Проектирование системы 1", "Проектирование системы 2"'
            )
