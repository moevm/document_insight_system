...
class TitleFormatCheck(BasePresCriterion):
    ...
    def empty_verdict(self):
        return format_header(
            ...
            'Убедитесь, что слайд при наведении на него курсора имеет название, соответствующее заголовку '\
            'на самом слайде.\nДля добавления заглавия в PowerPoint на вкладке Вид нажмите кнопку Режим структуры'\
            ' и щелкните справа от нужного слайда. Затем введите название'
        )
