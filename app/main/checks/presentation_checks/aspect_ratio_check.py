...
class PresAspectRatioCheck(BasePresCriterion):
    ...
    def __init__(self, file_info, correct_ratios=[Ratio(4, 3), Ratio(16, 9)]):
        super().__init__(file_info)
        self.correct_ratios = correct_ratios        

    def _is_correct_ratio(self, aspect_ratio: Ratio):
    ...
    def check(self):
        ...
        if self._is_correct_ratio(aspect_ratio):
