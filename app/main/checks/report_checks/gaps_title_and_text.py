    ...
    def check(self):
        try:
            ...
            if len(fail_headers_info) == 0:
                return answer(True, "Проверка разрывов между заголовком и текстом пройдена! Все заголовки и следующий за ними текст находятся на одной странице.")
            ...
            return answer(False, f"Ошибка при проверке разрывов между заголовком и текстом: {str(e)}")
