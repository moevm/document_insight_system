...
class CompareGoalAndContentCheck(BaseReportCriterion):
    ...
    _description = "Степень раскрытия цели в содержании"
    ...
    def check(self):
        ...
        if avg < self.to_pass:
            return answer(
                False, f"Цель недостаточно раскрыта в содержании (нужно {self.to_pass * 100}%, набрано {avg * 100}%)"
            )
        ...
        result += "<br><b>7 разделов, наиболее раскрывающих тему:</b><br>"
