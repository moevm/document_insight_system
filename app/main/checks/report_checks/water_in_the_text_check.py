...
class WaterInTheTextCheck(BaseReportCriterion):
    ...
    def __init__(
        self,
        file_info,
        watery_phrase_threshold=0.5,
        long_sentence_threshold=0.5,
        meaningful_word_threshold=0.5,
        long_sentence_word_limit=30,
    ):
    ...
    def check(self):
        ...
        result_str = (
            f'''Значимыми словами считаются существительные, прилагательные/краткие прилагательные и глаголы.
                    <br><br>
