...
class StyleCheckSettings:
    ...
    STD_BANNED_WORDS = ('мы', 'наш', 'наши',
        ...
        'тестить', 'тул', 'тула', 'тулза', 'фиксить', 'флажок', 'юзкейс', 'продакт', 'продакшн',
        'прод', 'фидбек', 'дедлайн', 'дэдлайн', 'оптимально', 'надежный', 'интуитивный',
        'хороший', 'плохой', 'идеальный', 'быстро', 'медленно', 'какой-нибудь', 'некоторый', 'почти', 'десктопный',
        'интуитивно понятный',        
    )
    STD_WARNED_WORDS = ('машина', 'оптимальный', 'мой', 'флаг', 'удобный', 'в реальном времени', 'популярный',
        'гибкий', 'дружелюбный интерфейс', 'из коробки', 'быстрый', 'классический', 'тестирование', 'опрос',
        'сюжет') # TODO: list of "warning" words
    STD_MIN_LIT_REF = 1
