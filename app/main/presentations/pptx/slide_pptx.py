    ...
    def __init__(self, container, w, h, index=-1):
        ...
        if self.images:
            for image in self.images:
                ...
                It is work this way, because a holder for picture and a holder
                    for capture don't strictly correspond in size.
                For example, sometimes the capture holder runs over the picture holder,
                    the text width is always different ect
                '''
