...
def parse_arguments():
    ...
    parser.add_argument(
        '--pres',
        type=str,
        default=os.path.join(script_dir, 'tests_data/example_of_pres.pptx'),
        help='your path to press for testing',
    )
    parser.add_argument(
        '--report',
        type=str,
        default=os.path.join(script_dir, 'tests_data/example_of_report.docx'),
        help='your path to report in .docx',
    )
    parser.add_argument(
        '--report_doc',
        type=str,
        default=os.path.join(script_dir, 'tests_data/example_of_report.doc'),
