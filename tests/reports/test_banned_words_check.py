...
class TestReportBannedWordsCheck:
    ...
    def test_02_banned_words_found(self, reports_fixture_dir):
        ...
        orig_words = StyleCheckSettings.VKR_CONFIG['any_header']['banned_words']
        orig_min = StyleCheckSettings.VKR_CONFIG['any_header']['min_count_for_banned_words_check']
        StyleCheckSettings.VKR_CONFIG['any_header']['banned_words'] = ('bannedword',)
        StyleCheckSettings.VKR_CONFIG['any_header']['min_count_for_banned_words_check'] = 0
        ...
        try:
            ...
            StyleCheckSettings.VKR_CONFIG['any_header']['banned_words'] = orig_words
            StyleCheckSettings.VKR_CONFIG['any_header']['min_count_for_banned_words_check'] = orig_min
